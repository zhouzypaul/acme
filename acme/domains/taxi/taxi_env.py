...
class TaxiEnv(InnerTaxiEnv):
    def __init__(
        ...
        bonus_for_passenger_in_taxi: float = 0.
    ):
        self.size = size
        self.num_passengers = num_passengers
        self.goal_conditioned = goal_conditioned
        self._n_goal_channels = n_goal_channels
        self._bonus_for_passenger_in_taxi = bonus_for_passenger_in_taxi
    ...
    def step(self, action):
        ...
        reward = float(reward) + (self._bonus_for_passenger_in_taxi * info['in_taxi'])
